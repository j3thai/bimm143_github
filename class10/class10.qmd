...
```
The median is a better representation of the center of distribution, which is below 50%
...
```
They are significantly different, shown with the small p-value in the t-test
...
Chocolate and winpercent appear to the most postiively correlated, followed by the chocolate and bar variables.
...
The original variables picked up strongly by PC1 positively are pluribus, hard, and fruity, and this makes sense because PC1 would show the measurements of hard fruity candy that comes in a bag or in multiples.
